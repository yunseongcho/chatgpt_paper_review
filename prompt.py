...
A. Author, B. Author, and C. Author, "Title of the paper," in Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), Year""",
    ...
    "Introduction": {
        "Background": "제공된 논문을 면밀히 검토하여, 무엇이 이 연구를 시작하게한 주요한 동기(motivation) 이었는지 어떤 문제(problem) 나 도전(challenge) 을 해결하려고 했는지 풍부하고 상세하게 설명해주십시오.",
        "Contribution": "제공된 논문을 면밀히 검토하여, 이 논문의 주요 기여 (contribution) 에 대한 풍부하고 상세한 설명을 제공해 주실 수 있을까요?"
    },
    ...
    "Related Works": {
        ...
        "Related Works": "제공된 논문을 면밀히 검토하여, 논문에서 다루고 있는 Task 혹은 Method 와 밀접한 연관이 있는 핵심 연구들을 소개해주실 수 있나요? 논문의 내용을 기반으로 답변해주십시오."
    },
...
A. Author, B. Author, and C. Author, "Title of the paper," in Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), Year""",
        ...
        "Methodology": "제공된 논문을 면밀히 검토하여, 논문에서 사용된 주된 방법론 (Method) 에 대해 풍부하고 상세한 설명을 제공해 주실 수 있을까요? 방법론을 단계적 프로세스로 세분화하여 명확하고 이해하기 쉽게 설명해 주시면 정말 감사하겠습니다. 답변이 길어져도 좋습니다.",
        "Figure": "제공된 논문을 면밀히 검토하여, 방법론의 모델 또는 프레임워크 아키텍처, 추론 방법 등을 나타내는 그림의 위치를 논문을 기반으로 알려주시고, 그 그림에 대해 설명해준다면 감사하겠습니다.",
