...
"제공된 논문의 방법론 부분을 면밀히 검토하여 논문의 내용을 바탕으로, 논문의 훈련 방법과 손실 함수(loss function)에 대해 풍부하고 상세한 설명을 제공해 주실 수 있을까요? Training 방법과 손실 함수들이 Training의 어떤 단계에 쓰이는 지, 그리고 손실 함수들의 목적과 기능을 이해하기 쉽고 자세하게 설명해 주시기 바랍니다. 단계적 프로세스로 세분화하여 명확하고 이해하기 쉽게 설명해 주시면 정말 감사하겠습니다. 추가적인 증명이 필요하다면 supplemental material 또는 appendix를 참조하십시오. 답변이 길어져도 좋습니다.",
...
"제공된 논문의 실험 결과 및 해석 부분을 면밀히 검토하여, 훈련(Training) 과정에서 사용된 구현 세부 사항(implementation details) 이나 실험 설정에 대해 포괄적으로 설명해 주시겠어요? 특히 모델 훈련에 사용된 GPU의 수와 유형, 그리고 훈련 기간에 대해 알고 싶습니다. 또한 구체적인 하이퍼파라미터도 알려주세요. 첨부한 supplemental material/appendix도 참고 바랍니다.",
...
A. Author, B. Author, and C. Author, "Title of the paper," in Proceedings of the IEEE Conference on Computer Vision and Pattern Recognition (CVPR), Year""",
    ...
    "Quantitative Result": 
"제공된 논문의 실험 결과 및 해석 부분을 면밀히 검토하여, 이 논문에서 제시된 방법론이 달성한 결과에 대한 종합적인 분석, 특히 앞서 언급한 데이터셋 (datasets) 및 양적 지표 (quantitative metrics) 관련된 분석을 제공해 주시겠습니까? 논문의 도표를 참고하여 이 방법론의 강점과 약점을 간략히 설명하고 이러한 결과가 도출된 이유에 대한 설명을 제공해 주십시오. 양적 결과를 나타내는 도표의 위치 또한 알려주시면 대단히 감사하겠습니다. 첨부한 supplemental material/appendix도 참고 바랍니다. 모든 답변은 논문을 기반으로 작성되어야만 합니다. 해당 정보가 없다면 없다고 말씀해주세요.",
        
    "Qualitative Result": 
"제공된 논문의 실험 결과 및 해석 부분을 면밀히 검토하여, 논문에서 제시된 질적 결과(qualitative result)에 대해 포괄적인 설명과 분석을 제공해 주실 수 있을까요? 또한, 이러한 질적 결과(qualitative result)를 완전히 이해하기 위해 몇 번째 그림과 섹션을 참조해야 하는지 구체적으로 알려주실 수 있을까요? 첨부한 supplemental material/appendix도 참고 바랍니다. 모든 답변은 논문을 기반으로 작성되어야만 합니다. 해당 정보가 없다면 없다고 말씀해주세요.",

    "Ablation Study": 
"제공된 논문의 실험 결과 및 해석 부분을 면밀히 검토하여, 논문에서 언급된 ablation study에 대해 포괄적인 설명을 제공해주시겠습니까? 연구의 목적, 방법론, 결과를 포함하여 ablation study에 대한 상세한 설명을 해주세요. 또한, ablation study 결과의 중요성과 의미를 명확히 알려주시기 바랍니다. supplemental material/appendix도 참고 바랍니다. 만약 ablation study가 없다면 없다고 말해주세요. 모든 답변은 논문을 기반으로 작성되어야만 합니다. 해당 정보가 없다면 없다고 말씀해주세요.",
